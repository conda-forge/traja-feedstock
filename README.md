...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/traja-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `traja` can be installed with:

```
conda install traja
```

It is possible to list all of the versions of `traja` available on your platform with:
